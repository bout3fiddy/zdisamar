...
Use `zig build test-validation-o2a-vendor -Doptimize=ReleaseFast` for the opt-in O2A vendor-parity compare-and-time lane against the cached `Config_O2_with_CIA.in` reference spectrum.
