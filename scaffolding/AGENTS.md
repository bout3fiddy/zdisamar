...
- Keep product instrumentation code under `src/instrumentation/` limited to narrow facades. Do not put capture scripts, file formats, report generation, or profiler setup in RTM routines.
