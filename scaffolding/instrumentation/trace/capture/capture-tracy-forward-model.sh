...
usage() {
  cat <<'USAGE'
Usage:
  scaffolding/instrumentation/trace/capture/capture-tracy-forward-model.sh [--seconds N] [--no-open]
...
Examples:
  ...
  scaffolding/instrumentation/trace/capture/capture-tracy-forward-model.sh --seconds 20 --no-open
USAGE
}
...
trace_root="$repo_root/scaffolding/instrumentation/trace/evidence"
