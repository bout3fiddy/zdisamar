...
scaffolding/instrumentation/perturbation/
  README.md
  sweep/run_perturbation_sweep.py
  analysis/analyze_perturbation_sweep.py
  analysis/schema.md
```
...
zig build perturbation-sensitivity -Doptimize=ReleaseFast -- \
  --output-dir out/scaffolding/perturbation/data/o2a-default
```

Generated data stays ignored under `out/scaffolding/perturbation/data/`.
...
under `out/scaffolding/perturbation/data/`.
