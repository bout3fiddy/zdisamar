...
older scenes; it is not the current forward elapsed time.
...
| Fixed-shape matrix math | Use the 20-stream shapes directly: common matrices are 12x10 and 12x12. | `5.911137 s -> 2.460360 s` |
...
do not change the retrieval math or the O2A physical model.
