...
```sh
uvx --from jupyterlab jupyter lab scaffolding/reports/performance/o2a-calculation-demo.ipynb
```
...
Performance trace outputs live under `scaffolding/instrumentation/trace/evidence/`.
...
validation/outputs/optimal_estimation/paired_oe_retrieved_fast_scatter.png
