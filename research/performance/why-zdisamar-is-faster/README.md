...
Current zdisamar timing:

```text
prepare_o2a                 0.161262 s
forward model               2.033145 s
...
- [Checkpoint timings](checkpoint-timings.md): exact script, commits, commands, and the measured 79-second, 35-second, 8-second, and 2-second rows.
