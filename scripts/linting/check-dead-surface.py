...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("src/cache/profile_line_memory.zig", "buildO2ProfileLineValuesForWavelengths"): "wp4-staged spectroscopy cache builder; session runner must consume before WP4 close",
