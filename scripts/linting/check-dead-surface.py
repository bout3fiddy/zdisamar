...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("src/cache/profile_line_memory.zig", "buildReferenceProfileLineValuesForWavelengths"): "wp4-staged spectroscopy cache builder; session runner must consume before WP4 close",
    ...
    ("src/root.zig", "deinitReferenceO2RunTables"): "wp4-staged root surface; C API ownership tests must wire before WP4 close",
    ...
    ("src/setup/refresh_profile_lines.zig", "rebuildReferenceProfileLineValues"): "wp5-staged refresh path, uncalled and untested; WP5 must test before first use",
    ("src/setup/refresh_tables.zig", "rebuildReferenceTables"): "wp5-staged refresh path, uncalled and untested; WP5 must test before first use",
    ...
    ("src/spectrum/spectrum_run.zig", "prefetchReferenceRadianceRowsSingleWorker"): "wp4-staged prefetch loop; collapse with generic production loop before WP4 close",
    ("src/spectrum/spectrum_run.zig", "FirstWorkerErrorState"): "wp4-staged worker kit; production runner must wire before WP4 close",
    ("src/spectrum/spectrum_run.zig", "staticRange"): "wp4-staged worker kit; production runner must wire before WP4 close",
    ("src/spectrum/spectrum_run.zig", "nextStaticChunk"): "wp4-staged worker kit; production runner must wire before WP4 close",
    ...
    ("src/spectrum/spectrum_run.zig", "preferredWorkerCount"): "wp4-staged worker kit; production runner must wire before WP4 close",
    ("src/spectrum/spectrum_run.zig", "preferredWorkerCountForCpuCount"): "wp4-staged worker kit; production runner must wire before WP4 close",
