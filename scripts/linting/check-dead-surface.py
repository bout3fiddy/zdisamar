...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("src/transport/matrix_12x10.zig", "smulInto"): "matrix oracle/helper; production uses narrower known-product Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "smulIntoKnownTraces"): "matrix oracle/helper; production uses narrower known-product Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "smulIntoKnownTracesIfNonzero"): "matrix oracle/helper; production uses narrower known-product Into kernels from layer_reflect_transmit",
    ...
    ("src/transport/matrix_12x10.zig", "matAddSemul3"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "smulAddSemul3"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "smulAddSemul3KnownRightTrace"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "semulAdd"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "matAddEsmul3"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "matAddEsmul"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "esmulSemul"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
    ("src/transport/matrix_12x10.zig", "esmulSemulAdd"): "matrix oracle/helper; production uses caller-owned Into kernels from layer_reflect_transmit",
