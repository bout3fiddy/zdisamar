...
QUANTITY_LABELS = {
    ...
    "cia_share_of_total_absorption": "CIA share of absorption",
    "cia_share_of_total_optical_depth": "CIA share of total optical depth",
    "cia_cross_section_cm5_per_molecule2": "CIA cross section cm5 per molecule2",
