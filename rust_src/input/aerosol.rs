...
use super::{
    AerosolType, FractionControl, FractionTarget, IntervalPlacement, ParticlePlacementSemantics,
};
...
impl Aerosol {
    pub fn resolved_placement(&self) -> IntervalPlacement {
        ...
        IntervalPlacement {
            ...
            bottom_altitude_km: (self.layer_center_km - 0.5 * self.layer_width_km).max(0.0),
