...
- Use this tree for tracked O2 A output-validation evidence that is intentionally committed: zdisamar versus DISAMAR reference outputs, zdisamar normal versus fast-mode outputs, and Python optimal-estimation retrieval outputs.
- Keep validation-specific O2 A maintenance scripts in this directory when they run reference cases, compare outputs, or rewrite the tracked validation bundle.
...
- Keep shared O2 A validation setup under `validation/o2a/`; reserve
