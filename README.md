...
- Default references: the committed 701-sample DISAMAR forward and
  reflectance-Jacobian fixtures under `validation/spectra/data/`.
...
- `validation/spectra/plots/o2a_validation.png`, `validation/spectra/data/comparison_metrics.json`, and
  `validation/spectra/data/bundle_manifest.json` are the bounded O2A forward/Jacobian
