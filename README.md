...
- Validation script: `validation/plot_validation.py`
- Default references: the committed 701-sample DISAMAR forward and
  reflectance-Jacobian fixtures under `validation/data/`.
...
- `validation/plots/o2a_validation.png`, `validation/data/comparison_metrics.json`, and
  `validation/data/bundle_manifest.json` are the bounded O2A forward/Jacobian
