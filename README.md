...
- `validation/o2a_with_cia_disamar_reference.csv` is the committed vendor comparison CSV.
- `validation/current_vs_vendor_*.png`, `validation/comparison_metrics.json`, and `validation/bundle_manifest.json`
  are the bounded O2A compatibility artifacts generated by the tracked plot bundle.
